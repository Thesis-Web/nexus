...
// §28.2 — Lexical Normalizer (verb cleanup helper, still load-bearing for
// the planner's deterministic verb resolution). The post-inference
// normalizer it formerly fed is RETIRED per F4.20 / Q6 — model output
