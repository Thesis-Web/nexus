...
export class SqliteDelegationStore implements DelegationStore {
  ...
  async getById(delegationId: Uuid): Promise<DelegationContext | null> {
    const row = this.db
