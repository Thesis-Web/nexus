 ...
 */
import {
  GATE_ID, GENESIS_HASH, OUTCOME_LABEL, FINAL_OUTCOME, DENIAL_CODE,
  type Gate, type GateResult, type AgentAction, type PipelineContext,
  type GateDecision, type EvidenceRecord, type FinalOutcome,
