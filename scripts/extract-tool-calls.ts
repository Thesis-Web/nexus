/**
 * Provider tool-call extraction — composition-boundary helper.
 *
 * File: scripts/extract-tool-calls.ts
 * CLAUDE-CODE-ACTION-NORMALIZER-PHASE-C §2 + §6.
 *
 ...
 *   - The PostInferenceNormalizer (§28.1) is provider-agnostic — it
 *     consumes ExtractedToolCall, never raw provider responses.
 *
